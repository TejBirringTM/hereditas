...
export type LMaritalSpouse = Relationship<"MaritalSpouse", "Male" | "Female", "Male" | "Female">;

// Marital Progeny
export type LMaritalProgeny = Relationship<"MaritalProgeny", "Marriage", "Male" | "Female">;
export type LAdoptedMaritalProgeny = Relationship<"AdoptedMaritalProgeny", "Marriage", "Male" | "Female">;

export type LMaritalProgenitor = Relationship<"MaritalProgenitor", "Male" | "Female", "Marriage">;
export type LAdoptiveMaritalProgenitor = Relationship<"AdoptiveMaritalProgenitor", "Male" | "Female", "Marriage">;

// Parentage
export type LMother = Relationship<"Mother", "Male" | "Female", "Female">;
export type LFather = Relationship<"Father", "Male" | "Female", "Male">;
export type LParent = Relationship<"Parent", "Male" | "Female", "Male" | "Female">;

export type LSon = Relationship<"Son", "Male" | "Female", "Male">;
export type LDaughter = Relationship<"Daughter", "Male" | "Female", "Female">;
export type LChild = Relationship<"Child", "Male" | "Female", "Male" | "Female">;

// Adoptive Parentage
export type LAdoptiveMother = Relationship<"AdoptiveMother", "Male" | "Female", "Female">;
export type LAdoptiveFather = Relationship<"AdoptiveFather", "Male" | "Female", "Male">;
export type LAdoptiveParent = Relationship<"AdoptiveParent", "Male" | "Female", "Male" | "Female">;

export type LAdoptedSon = Relationship<"AdoptedSon", "Male" | "Female", "Male">;
export type LAdoptedDaughter = Relationship<"AdoptedDaughter", "Male" | "Female", "Female">;
export type LAdoptedChild = Relationship<"AdoptedChild", "Male" | "Female", "Male" | "Female">;

// Sibling
export type LFullSibling = Relationship<"FullSibling", "Male" | "Female", "Male" | "Female">;
export type LAdoptiveFullSibling = Relationship<"AdoptiveFullSibling", "Male" | "Female", "Male" | "Female">;

import { declareString, declareNatural } from "../common/validation.ts";
import * as v from "@valibot/valibot"

const PathSegment = declareString("Path Segment", "A lowercase alphanumeric string that may include hyphens and underscores, but neither as the first nor last character.", /([a-z0-9]+[a-z0-9\-\_]*[a-z0-9]+)/);
...
export const requestPath = (path: TRequestPath, versionMajor: TVersionMajor) => {

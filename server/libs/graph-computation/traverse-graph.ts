...
export interface VisitContext<Node> {
  rootNode: Node;
  currentNode: {
    node: Node;
    neighbours: {
...
export function traverseGraphDepthFirst<Node>(
  startNode: Node,
  getNeighbours: NeighbourFn<Node>,
  options?: DepthFirstOptions<Node>,
) {
...
export function traverseGraphBreadthFirst<Node>(
  startNode: Node,
  getNeighbours: NeighbourFn<Node>,
  options?: BreadthFirstOptions<Node>,
) {
